...
Depending on your output, you may need to adjust the size of the plot. For instance, I set my rmarkdown chunk to `{r plot, fig.width = 6, fig.height = 6, fig.align = "center"}`, but you can see that the plot tends to get squished. It is recommended to use the `ggsave` function to save the plot to a file. 

```{r save}
ggsave("putellas.png", p, width = 3000, height =2800, units = "px")
```

Once you have save your image, I have found that the code chunk `{r plot, out.width = "100%", fig.align = "center"}` renders the image nicely for html output via quarto or rmarkdown (utilized in the below plots).
